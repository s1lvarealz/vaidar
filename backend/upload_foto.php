...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        $destino = "../frontend/images/perfil/".$novo_nome;

        if (move_uploaded_file($nome_temp, $destino)) {
            var_dump($novo_nome);
            var_dump($user_id);
            
            $sql = "UPDATE perfis SET foto_perfil='$novo_nome' WHERE id_utilizador='$user_id'";
...
header("Location: ../frontend/editar_perfil.php");
exit();
